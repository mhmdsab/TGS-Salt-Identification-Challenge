...
class Feature_Pyramid_Attention:
    ...
    def downsample(self):
        ...
        conv7_1 = Conv2D(self.layer_shape[-1], 5, padding = 'same', kernel_initializer='he_normal')(max_pool_1)
        conv7_1 = BatchNormalization()(conv7_1)
        conv7_1 = Activation('relu')(conv7_1)
        
        conv7_2 = Conv2D(self.layer_shape[-1], 5, padding = 'same', kernel_initializer='he_normal')(conv7_1)
        ...
        conv5_1 = Conv2D(self.layer_shape[-1], 3, padding = 'same', kernel_initializer='he_normal')(max_pool_2)
        conv5_1 = BatchNormalization()(conv5_1)
        conv5_1 = Activation('relu')(conv5_1)
        
        conv5_2 = Conv2D(self.layer_shape[-1], 3, padding = 'same', kernel_initializer='he_normal')(conv5_1)
        conv5_2 = BatchNormalization()(conv5_2)
        conv5_2 = Activation('relu')(conv5_2)
        
        max_pool_3 = MaxPooling2D(strides = 2)(conv5_1)
        
        conv3_1 = Conv2D(self.layer_shape[-1], 1, padding = 'same', kernel_initializer='he_normal')(max_pool_3)
        conv3_1 = BatchNormalization()(conv3_1)
        conv3_1 = Activation('relu')(conv3_1)
        
        conv3_2 = Conv2D(self.layer_shape[-1], 1, padding = 'same', kernel_initializer='he_normal')(conv3_1)
...
#        
    ...
    def FPA(self):
        ...
        added_fpa = Add(name = 'bottle_neck')([multiplied, gpb])
